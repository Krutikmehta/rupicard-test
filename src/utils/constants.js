...
export const ADDED_BENEFITS_DATA = [
  {
    ...
    img: "/images/whatsapp_bubble.webp",
  },
  {
    text: "No hidden charges, no last minute surprises.|100% money back guarantee if a charge is applied without your knowledge.",
    img: "/images/rupee_bubble.webp",
  },
  {
    text: "Super secure. Because we care about your money.|/images/pcidss_cert.svg",
    img: "/images/antivirus_bubble.webp",
  },
];
